...
export const itemsRepo: ItemRepoInterface = {
  ...
  async add(item: Omit<Item, 'id'>) {
    ...
    // } catch (err) {
    //   console.warn('Remote upsert failed (add):', err)
    // }
    return saved
  },
  ...
  async update(item) {
    ...
    // } catch (err) {
    //   console.warn('Remote upsert failed (update):', err)
    // }
  },
  ...
  async upsert(item) {
    ...
    //   await itemsFirebaseDS.upsert(item)
    // } catch (err) {
    //   console.warn('Remote upsert failed (upsert):', err)
    // }
  },
  ...
  async remove(id) {
    ...
    // } catch (err) {
    //   console.warn('Remote remove failed:', err)
    // }
  },
  ...
  async toggleResolved(id) {
    ...
    //   } catch (err) {
    //     console.warn('Remote markResolved failed:', err)
    //   }
    // }
  },
}
